    ...
    private void processInput(JSONObject input) {
        ...
        switch(action) {
            ...
            case Constants.Action.READ:
                ...
                PieOSXClient.getDatabaseManager().markAsRead(messageId);
