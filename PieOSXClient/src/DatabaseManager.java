...
class DatabaseManager {
    ...
    DatabaseManager() {
        ...
        try {
            ...
            chatDb = DriverManager.getConnection("jdbc:sqlite:" + PieOSXClient.getHomeDirectory() + "/Library/Messages/chat.db");
            contactsDb = DriverManager.getConnection("jdbc:sqlite:" + PieOSXClient.getHomeDirectory() + "/Library/Application Support/AddressBook/AddressBook-v22.abcddb");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
